...
PHASH_THRESHOLD = 5         # 画面変化あり判定の phash 距離閾値
...
# ─── メニュー画面キーワード (左上に表示されるサブ画面名) ───
_MENU_SCREEN_KWS: list[str] = [
    "ガチャ", "交換所", "ショップ", "パーティ", "編成",
    "ミッション", "メニュー", "設定", "フレンド", "プレゼント",
    "クエスト", "育成", "タワー",
]

# ─── 課金保護: 通貨消費キーワード ───
_CURRENCY_SPEND_KWS: tuple = (
    "消費", "有償", "無償", "マギカストーン", "マジカルキューブ",
    "購入", "課金",
)
...
_IMMEDIATE_ACTIONS: frozenset = frozenset([
    ...
    "HOME_CLEAR_CHECK", "HOME_TUTORIAL_TAP",
